...
<br />
<?php
	$sql = "SELECT * FROM usupaciente as pac INNER JOIN consulta as con ON pac.id_usupaciente=con.usupaciente_id_usupaciente WHERE pac.id_usupaciente=".$secao_id;
	...
	if($qtd > 0){
		...
		while($row = $resultado->fetch_assoc()){
			...
			print "<td>".@$row["nome_usupaciente"]."</td>";
			print "<td>".@$row["cpf"]."</td>";
