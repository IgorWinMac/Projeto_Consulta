				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown active">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<a class="dropdown-item" href="index.php?page=login-cliente">Login do Paciente</a>
						</div>
					</li>
				</ul>
			</div>
...
$usuario      = $_REQUEST['nome_usupaciente'];
$senha        = $_REQUEST['senha'];

$sql = "SELECT * FROM usupaciente WHERE nome_usupaciente = '$usuario' AND senha = '$senha' ";
...
$qtd = $resultado->num_rows;
	...
	if($qtd == 0){
		...
		$_SESSION['nome_usupaciente'] = $usuario;
		$_SESSION['senha']            = $senha;
		$row = $resultado->fetch_assoc();
		$_SESSION["id"]               = $row["id_usupaciente"];
...
<div class="container">
<h1><p class="serif text-primary">Área do Paciente</p></h1> 
	<div class="form-group col-md-5">
		<label>Nome do Paciente</label>
		<input type="text" name="nome_usupaciente" class="form-control">
		<label>Senha</label>
